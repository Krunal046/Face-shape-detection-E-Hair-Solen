...
import com.example.demo.common.helpers.*
import com.example.demo.common.rendering.BackgroundRenderer
import com.example.demo.common.rendering.ObjectRenderer
import com.example.demo.ui.AugmentedFaceRenderer
...
class Ar : AppCompatActivity() , GLSurfaceView.Renderer {
...
/*
 ...
 /* override fun onRequestPermissionsResult(
    ...
    companion object {
        private val TAG = Ar::class.java.simpleName
